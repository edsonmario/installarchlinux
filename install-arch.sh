...
power-profiles-daemon kcalc krita filelight ksystemlog kgpg partitionmanager skanlite kmousetool kcharselect krdc kompare sweeper acpid hplip usbutils
...
unrar unzip p7zip mesa ark lm_sensors i2c-tools libvdpau-va-gl libva-vdpau-driver libva-utils vdpauinfo mesa-utils ntfs-3g dosfstools exfat-utils btrfs-progs tailscale zerotier-one git wget curl
